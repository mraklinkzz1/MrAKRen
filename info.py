...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002124248397')) #Log channel id ( make sure bot is admin )
...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = environ.get('APP_NAME', 'mrakren')
else:
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '0.0.0.0'))
FQDN = str(env.get("FQDN", "https://mrakren.onrender.com/"))
...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = str(getenv('APP_NAME', 'mrakren'))
