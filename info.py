...
API_ID = int(environ.get('API_ID', '22615660'))
API_HASH = environ.get('API_HASH', '906e31e7abb5b7bc2990f8f78e8e4a78')
BOT_TOKEN = environ.get('BOT_TOKEN', "7280734409:AAGXg2fw25i6HTXwhZXFsS_jijXIgzfWozQ")
...
USERNAME = environ.get("USERNAME", "https://t.me/Iam_MrAK")
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6119769857').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002208166772').split()] #Channel id for auto indexing ( make sure bot is admin )
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1002208166772') #Channel / Group Id for force sub ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://akmonsterprogrammer:S.Aruna1155182089@anime.n68t8wz.mongodb.net/?retryWrites=true&w=majority&appName=anime")
...
GRP_LNK = environ.get('GRP_LNK', 'https://telegram.me/+LL6rncUCRZ00ODc1')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002116232445')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://telegram.me/+LL6rncUCRZ00ODc1') #Support group link ( make sure bot is admin )
...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = environ.get('APP_NAME', 'mrakanime-61c99f7f1604')
else:
    ON_HEROKU = False
...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = str(getenv('APP_NAME', 'mrakanime-61c99f7f1604'))
