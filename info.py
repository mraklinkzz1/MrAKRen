...
BOT_TOKEN = environ.get('BOT_TOKEN', "6165455939:AAH83tOFkQmmTdKUTxJJTMlLXq722rI4oCM")
...
GRP_LNK = environ.get('GRP_LNK', 'https://telegram.me/+SKa11HVL-jU1MTNl')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001995700449')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://telegram.me/+SKa11HVL-jU1MTNl') #Support group link ( make sure bot is admin )
...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = environ.get('APP_NAME', 'mrakmovie-0db76f622bdb')
else:
    ON_HEROKU = False
...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = str(getenv('APP_NAME', 'mrakmovie-0db76f622bdb'))
