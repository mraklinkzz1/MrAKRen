...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://akmonsterprogrammer:S.Aruna1155182089@mywork.z0hcudp.mongodb.net/?retryWrites=true&w=majority&appName=mywork")
DATABASE_NAME = environ.get('DATABASE_NAME', "mywork")
...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = environ.get('APP_NAME', 'mrakwork-a0ea9a3be23c')
else:
    ON_HEROKU = False
...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = str(getenv('APP_NAME', 'mrakwork-a0ea9a3be23c'))
