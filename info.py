...
auth_channel_2 = environ.get('AUTH_CHANNEL', '-1002044250842') #Channel / Group Id for force sub ( make sure bot is admin )
 #Channel / Group Id for force sub ( make sure bot is admin )
