...
BOT_TOKEN = environ.get('BOT_TOKEN', "7381849410:AAEdcGfp1W41Q5SYAPIavcZ3HHMc7SYk8l8")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002053122232')) #Log channel id ( make sure bot is admin )
